  ...
  <head>
   <meta charset="utf-8">
	...
	<body>
		...
		<a href="banSinger"><button class="layui-btn">已删除歌手</button></a>
		<fieldset class="layui-elem-field layui-field-title">
			<legend>基本查询</legend>
		</fieldset>
		<form class="layui-form" action="getSingerPo" method="post">
			...
			<table>
				...
				<tbody class="tb">
					...
					<tr>
						...
						<td>
							<a href="selectSingerById?singerId=${singer.singerid  }"><button class="layui-btn layui-btn-small"><i class="layui-icon"></i></button></a>
					...
					confirmTrans = function(id) {
						...
						parent.layer.msg('确定要删除吗？', {
							...
							yes: function(){
							     ...
							     location.href="deleteSingerPo?singerId="+id;
						    				 ...
						    				 data.list.forEach(function(value,index){//数据渲染
						    					/*  console.log(value); */
						    					 ...
						    					 var $tr=$('<tr><td><img src="../'+value.photourl+'"/></td>'
						    								...
						    								+'<td><a href="selectSingerById?singerId='+value.singerid+'"><button class="layui-btn layui-btn-small"><i class="layui-icon"></i><button></a>'
						    								+'<button data-method="confirmTrans('+value.singerid+')" class="layui-btn layui-btn-small"><i class="layui-icon"></i><button></a></td></tr>');
						    					 $(".tb").append($tr);
												});
						    			 }
