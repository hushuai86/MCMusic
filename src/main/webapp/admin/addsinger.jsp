  ...
  <head>
	...
	<body>
		...
		<div class="center">
			...
			<div class="message">
				<form method="post" action="addSinger"  enctype="multipart/form-data">
				 <input  type="hidden" name="url" id="url"/>
					<div class="layui-form-item">
						<label class="layui-form-label">歌手名称</label>
						<div class="layui-input-block">
							<input name="singername" required lay-verify="title" autocomplete="off" placeholder="请输入歌手名称" class="layui-input" type="text">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">歌手热度</label>
						<div class="layui-input-block">
							<input name="accesscount" lay-verify="title" value="0" readonly autocomplete="off" placeholder="请输入歌手热度" class="layui-input" type="text">
						</div>
					</div>
					<div class="layui-form-item">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block" >
							<input style="margin-top: 10px;" name="singersex" value="1" title="男" checked="" type="radio">男
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input name="date1" id="test1" required lay-verify="date" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input" type="text">
						</div>
					</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input name="date2" id="test2" required lay-verify="date" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input" type="text">
						</div>
					</div>
					<div class="layui-form-item">
