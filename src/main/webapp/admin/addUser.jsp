				...
				<form action="adminAddUser" method="post">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input name="loginid" lay-verify="title" required  autocomplete="off" placeholder="请输入用户账号" class="layui-input" type="text">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">用户密码</label>
						<div class="layui-input-block">
							<input name="password" lay-verify="title" required autocomplete="off" placeholder="请输入用户密码" class="layui-input" type="password">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">用户名称</label>
						<div class="layui-input-block">
							<input name="username" lay-verify="title" required autocomplete="off" placeholder="请输入用户密码" class="layui-input" type="text">
						</div>
					</div>
					<div class="layui-form-item">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<textarea placeholder="请输入内容" required name="sign" class="layui-textarea" style="width: 300px;"></textarea>
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">用户邮箱</label>
						<div class="layui-input-block">
							<input name="email" lay-verify="title"  required autocomplete="off" placeholder="请输入用户邮箱" class="layui-input" type="text">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">用户手机</label>
						<div class="layui-input-block">
							<input name="phone"  lay-verify="title" required autocomplete="off" placeholder="请输入用户邮箱" class="layui-input" type="text">
						</div>
					</div>
					<div class="layui-form-item" >
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input name="date" id="test2"  required lay-verify="date" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input" type="text">
						</div>
					</div>
					<div class="layui-form-item">
