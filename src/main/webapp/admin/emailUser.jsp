...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
 <html>
	...
	<body>
		...
		<a href="adminListUser"><button class="layui-btn">所有用户</button></a>
		<a href="toFreezeUser"><button class="layui-btn">已冻结用户</button></a>
		<fieldset class="layui-elem-field layui-field-title">
			<legend>基本查询</legend>
		</fieldset>
		<form class="layui-form" action="adminListEmailUser" method="post">
			...
			<c:forEach items="${pageBasePo.list}" var="user">
					<tr>
						...
						<td><fmt:formatDate value="${user.registationdate}"
								type="date" /></td>
						<td><a href="toAdminUpdateUser?userId=${user.userid}&type=email"><button
